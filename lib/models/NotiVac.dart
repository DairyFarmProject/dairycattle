...
class NotiVac {
  ...
  factory NotiVac.fromMap(Map<String, dynamic> map) {
    return NotiVac(
  ...
  factory NotiVac.fromJson(String source) => NotiVac.fromMap(json.decode(source));

  @override
  String toString() {
    return 'NotiVac(schedule_id: $schedule_id, vaccine_id: $vaccine_id, cow_id: $cow_id, vac_date: $vac_date, next_date: $next_date, note: $note, type_id: $type_id, specie_id: $specie_id, farm_id: $farm_id, status_id: $status_id, cow_no: $cow_no, cow_name: $cow_name, cow_birthday: $cow_birthday, cow_sex: $cow_sex, semen_id: $semen_id, semen_specie: $semen_specie, mom_id: $mom_id, mom_specie: $mom_specie, cow_image: $cow_image, vac_name_en: $vac_name_en, vac_name_th: $vac_name_th, detail: $detail)';
  }
