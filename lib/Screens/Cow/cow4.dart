...
class Cow4 extends StatefulWidget {
  static const routeName = '/cow4';
  @override
  _Cow4State createState() => _Cow4State();
}

class _Cow4State extends State<Cow4> {
  List<Cows> cow = [];
  ...
  Future<List<Cows>> getCow() async {
    ...
    final response = await http.post(
        Uri.https('heroku-diarycattle.herokuapp.com', 'filter/cowid/new'),
        headers: {
