...
class Cow2 extends StatefulWidget {
  static const routeName = '/cow2';
  @override
  _Cow2State createState() => _Cow2State();
}

class _Cow2State extends State<Cow2> {
  List<Cows> cow = [];
  ...
  Future<List<Cows>> getCow() async {
    ...
    final response = await http.post(
        Uri.https('heroku-diarycattle.herokuapp.com', 'filter/cowage/young'),
        headers: {
